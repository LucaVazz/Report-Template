...
% Uncomment if you want to mark the output pdf as a draft:
%\newcommand{\activatedraftmark}{def}
%\newcommand{\draftrevision}{1st}
...
%\newcommand{\useabsolutecaptionnumbers}{def}
...
%\newcommand{\useabsolutefootnotenumbers}{def}


% Uncomment if you want to write the main part of your report in german
%\newcommand{\usegerman}{def}
